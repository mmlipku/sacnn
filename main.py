...
def main():
    ...
    #training_data_loader = pickle.load(open("/data/CT/training_data.p","rb"))
    #validation_data_loader = pickle.load(open("/data/CT/validation_data.p","rb"))
    ...
    for epoch in range(opt.start_epoch, opt.nEpochs + 1):
        train(training_data_loader, optimizer, criterion, model, epoch)
...
def train(training_data_loader, optimizer, criterion, model, epoch):
